...
quando há o manipulador se aplicam torques nas juntas e, pela resposta do
manipulador, estima-se a matriz; ou pelo CAD do manipulador, pela utilização da
ferramenta SolidWorks. Foi utilizado o método de estimação pelo CAD do
...
parcial da matriz jacobiana $J$. %REFERENCIA
...
A análise dinâmica do manipulador MH12 mostrou que 