...
Essa abordagem é específica para cada manipulador da pesquisa de mercado. O
estudo retorna um caso aproximado da situação real e estima as possíveis
soluções da posição do manipulador em relação à pá, de forma que toda ela seja
revestida.
...
\begin{figure}[h!]	
	\includegraphics[width=\columnwidth]{figs/bighatch/mh12geom.jpg}
	\caption{Ilustração da interseção do espaço de trabalho simplificado do
...
\begin{figure}[h!]	
	\includegraphics[width=\columnwidth]{figs/bighatch/mh12circles.png}
