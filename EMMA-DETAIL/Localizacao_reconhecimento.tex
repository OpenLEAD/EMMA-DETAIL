...
avaliar qual o modelo mais próximo das medições atuais e ainda é possível nos
utilizar essa informação para fornecer uma medida de avalição de quão bom está a
similaridade do modelo com os dados reais.
...
possível armazená-los para evitar o seu processamento  durante o processamento
de uma nova nuvem de pontos. Utilizando-se a estratérgia de
...
figura \ref{fig::correspondence} ilustra a implementação do algoritmo com os
dados sintéticos de uma cena, utilizando-se porém o modelo real da pá, na qual
o modelo da pá está representado em amarelo, a pá identificada na cena em
vermelho e as correspondências conectadas pelas setas verdes.
